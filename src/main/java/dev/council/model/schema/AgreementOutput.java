...
/**
 * JSON schema DTO for LLM agreement analysis output.
 ...
 */
public record AgreementOutput(
    String analysis,
    List<ConsensusPoint> consensusPoints
) {
    /**
     * A point where multiple responses agree.
     */
    public record ConsensusPoint(
        String topic,
        String description,
